...
const sendGoogleOtpMail = async (recipientEmail, otp , type="register") => {
  try {
    const mailOptions = {
      from: `"Denial Assistance" <${process.env.EMAIL}>`,
      to: recipientEmail,
...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>This is an automated message from Denial Assistance.</p>
            <p>&copy; 2025 Denial Assistance. All rights reserved.</p>
        </div>
    </div>
</body>
</html>`,
...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>This is an automated notification from Denial Assistance system.</p>
